...
<div class="row">
	...
	<h1 class="dotmark">
	<i class="icon-cut"></i>
	PROMO BULAN PUASA GRATIS ONGKIR UNTUK KUE KERING
	</h1>
	</div>
	</div>
	<div class="span4 alignR">
	<p><b>Customer Care : 021 - XXXX XXXX</b></p>
		...
		<div class="container">
		  ...
		  <div class="nav-collapse">
			...
			<li class="dropdown">
				...
				<?php } else { ?> 
				<a id ="login" data-toggle="dropdown" class="dropdown-toggle" href="login.php"><span class="icon-lock"></span> Login <b class="caret"></b></a> <?php }?>
